...
let usernames: string[] = ['admin', 'maryam223', 'sara421', 'ali284', 'sehar657']
...
let currentUsers: string[] = ['admin', 'maryam223', 'sara421', 'ali284', 'sehar657']
let newUsers:string[] = ['admin', 'zubaida345', 'sara789', 'ali890', 'maryam123']
